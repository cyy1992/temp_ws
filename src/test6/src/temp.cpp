...
//      boost::bind(&KeyframePub::imgSyncCb4, this, _1, _2, _3, _4));
  ...
  getIntrinsicFromYaml("/home/cyy/projects/test6/test6/config/intrinsic_params.yaml");
...
void KeyframePub::analyzeImages(const std::vector<Mat>& imgs, visual_msgs::Keyframe& frame_info)
{
  for(int i = 0; i < imgs.size();i ++)
  {
    ...
    Mat undistort_img;
    undistort(img1,undistort_img,intrinsic_[i],distortion_[1]);
    
    std::vector<AprilTags::TagDetection>  
      tag_detections = tag_detector_->extractTags(undistort_img);
    ...
    for (unsigned int i = 0; i < tag_detections.size(); i++)
    {
      ...
      if(id < 30)
      {
        ...
        cout << "num1: " << num1  <<endl;
        /home/cyy/catkin_ws/src/visual_servo_iplus/src/detect_tag.cpp/home/cyy/catkin_ws/src/visual_servo_iplus/src/detect_tag.cpp
